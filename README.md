...
[Paper](https://arxiv.org/pdf/2604.18231) · [Code](https://github.com/comet-cc/AgenTEE)
...
[Paper](https://arxiv.org/pdf/2512.01594) · [Code](https://github.com/comet-cc/CAEC)
...
[Paper](https://arxiv.org/pdf/2404.00190) · [Code](https://github.com/comet-cc/GuaranTEE)
...
C3Infer is a research initiative focused on developing practical confidential systems for AI inference. Rather than relying solely on minimising the trusted computing base (TCB), the project emphasises restricting and verifying communication patterns between system components. The work centres on constructing secure multi-component pipelines for trusted execution environments and confidential virtual machines, with implementations targeting Arm CCA.
